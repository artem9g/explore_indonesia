 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".explore-secrets__slider")) new swiper_core_Swiper(".explore-secrets__slider", {
...
***************************************************************************** */
        ...
        var lg_zoom_min = __webpack_require__(395);
        var lg_video_min = __webpack_require__(184);
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            var videoContainer = document.getElementById("video"), videoControls = document.querySelectorAll(".video-control"), video = document.getElementById("hero-video");
        ...
        window.addEventListener("resize", (function() {
            var elements = document.querySelectorAll(".video-block__text");
            if (window.innerWidth <= 600) elements.forEach((function(element) {
                element.setAttribute("data-showmore-content", "30");
            })); else elements.forEach((function(element) {
                element.setAttribute("data-showmore-content", "300");
            }));
        }));
        window.addEventListener("resize", (function() {
            var elements = document.querySelectorAll(".item-there_text");
            if (window.innerWidth <= 600) elements.forEach((function(element) {
                element.setAttribute("data-showmore-content", "30");
            })); else elements.forEach((function(element) {
                element.setAttribute("data-showmore-content", "300");
